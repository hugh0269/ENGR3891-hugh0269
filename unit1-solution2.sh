...
cd angetritter
sudo mkdir -m 507 antrittung
sudo mkdir -m 116 "antrittung/ankaeser"
sudo mkdir -m 034 "beschmeckung"
sudo mkdir -m 323 "beschmeckung/ausgesprachs"
sudo mkdir -m 721 "beschmeckung/ausrauchheit"
sudo mkdir -m 420 "beschmeckung/aufkletts"
chown mail:student antrittung
chown games:dip "antrittung/ankaeser"
chown lp:audio "beschmeckung"
